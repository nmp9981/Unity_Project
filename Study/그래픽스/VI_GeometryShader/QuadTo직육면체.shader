Shader "Unlit/SampleGeometry"
{
    Properties
    {
         _Height("Height", float) = 7.0
         _TopColor("Top Color", Color) = (0.0, 0.0, 1.0, 1.0)
         _BottomColor("Bottom Color", Color) = (1.0, 1.0, 0.0, 1.0)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void geom(triangle v2g input[3],inout TriangleStream<g2f> outStream){
                ...
                float4 c = float4(0.0f,0.0f,_Height,1.0f) + (p0+p1+p2)*0.333333f;
