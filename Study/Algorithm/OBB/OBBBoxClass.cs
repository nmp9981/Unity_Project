...
public class OBBBoxClass
{
    ...
    /// 합친 메시로 OBB박스 생성
    /// </summary>
    public OBB MakeOBBAboutCombineMeshs(List<MeshFilter> meshFilterList,Transform transform)
    {
        Mesh newMesh = meshCombineClass.CombineAllMeshes(meshFilterList, transform);
    ...
    public void DrawOBBBOX(OBB obb, GameObject parentObj)
    {
